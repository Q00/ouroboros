...
- **skills/interview**: Add `ooo idk` for topic-specific knowledge calibration. Users can list unfamiliar terms or describe their understanding, and subsequent interview turns adapt vocabulary and explanation depth without weakening requirement rigor or treating calibration text as an interview answer.
