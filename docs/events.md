...
| `project_root` | `string` | Optional canonical identity root used to derive `project_id`; normally the source checkout, or the external common Git directory for `--separate-git-dir` repositories |
