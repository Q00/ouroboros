...
generates findings), but also ingests loosely-structured JSON or markdown from other
scanners.
...
[best-practices.md#cvss](https://github.com/anthropics/defending-code-reference-harness/blob/d3bea6b/docs/best-practices.md#cvss) in the reference harness.
...
```
/triage docs/security/VULN-FINDINGS.json --repo . --fp-rules .claude/fp-rules.txt   # vuln-scan output
