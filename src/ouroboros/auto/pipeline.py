...
from ouroboros.auto.seed_qa_repair import (
    SeedQaRepairMappingError,
)
from ouroboros.auto.seed_qa_repair import (
    clean_seed_qa_repair_text as _clean_seed_qa_repair_text,
)
from ouroboros.auto.seed_qa_repair import (
    normalized_seed_qa_feedback as _normalized_seed_qa_feedback,
)
from ouroboros.auto.seed_qa_repair import (
    normalized_seed_qa_lateral_feedback as _normalized_seed_qa_lateral_feedback,
)
from ouroboros.auto.seed_qa_repair import (
    safe_seed_qa_error_detail as _safe_seed_qa_error_detail,
)
from ouroboros.auto.seed_qa_repair import (
    safe_seed_qa_evidence as _safe_seed_qa_evidence,
)
from ouroboros.auto.seed_qa_repair import (
    safe_seed_qa_verdict as _safe_seed_qa_verdict,
)
    ...
    async def _run_seed_qa_gate(
        ...
        *,
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            qa_result = None
            transient_reason: tuple[str, str] | None = None
            for transient_attempt in range(_TRANSIENT_TOOL_ATTEMPTS):
                ...
                if candidate.error:
                    transient_reason = (
                        ...
                        f"{_safe_seed_qa_error_detail(candidate.error)}",
                    )
                    continue
                qa_result = candidate
                break
            ...
            if qa_result is None:
                reason, detail = transient_reason or (
                    "evaluator_error",
                    "Seed QA failed after transient retries",
                )
