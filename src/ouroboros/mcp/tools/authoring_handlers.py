...
def _build_interview_lateral_review_orchestration(
    *,
    ...
    sequential_mode = str(
        sequential_fallback.get("mode") or "sequential_persona_payload_dispatch"
    )
    ...
    return {
        ...
        "panel": {
            ...
            "parallel_preference": str(
                panel.get("parallel_preference")
                or "parallel_when_runtime_supports_subagents"
            ),
        ...
        try:
            ...
            if initial_context:
                ...
                if is_length_guard:
                    ...
                    start_meta["code_investigation_request"] = (
            ...
            if session_id:
                ...
                if answer_is_length_guard:
                    ...
                    answer_meta["code_investigation_request"] = (
                        _build_code_investigation_request(
                            session_id=session_id,
                            question=question,
                        )
