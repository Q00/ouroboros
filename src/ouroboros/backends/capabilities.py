...
def build_runtime_subagent_orchestration_contract(
    ...
    *,
    ...
    if capability.supports_native_parallel_subagents:
        ...
        runtime_instruction_handling = (
            ...
            "runtime's native parallel subagent primitive. Keep the MCP-declared "
            "sequential fallback available for downgraded runtime surfaces."
        )
    else:
    ...
    return RuntimeSubagentOrchestrationContract(
        ...
        supports_native_parallel_subagents=capability.supports_native_parallel_subagents,
