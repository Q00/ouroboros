...
class PluginManifest:
    ...
    # order matches the manifest's declaration. `frozenset` would reintroduce
    # nondeterministic order in CLI output and emitted permission events
    # for multi-entry manifests.
