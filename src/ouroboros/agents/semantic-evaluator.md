...
- questions_used: the concrete Socratic / ontology-gap questions you used to verify the artifact
- evidence: the concrete evidence from the artifact or source files that supports the verdict
