...
철학과 사용법을 대화로 듣고 싶다면 개발자 인터뷰가 있습니다: [하네스 엔지니어링이 궁금하다면 프롬프트를 멈추고 명세서를 작성하세요 — 평범한 사업가 AI 팟캐스트 #83](https://www.youtube.com/watch?v=OOScU5c8rPQ) (한국어, 인터뷰·모호도 게이트·세션 분리 이야기)
