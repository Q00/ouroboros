...
class TestSeed:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            'python -c "import sys; sys.exit(1)" || { :; true; }',
            'python -c "import sys; sys.exit(1)" || ( true && true )',
            'python -c "import sys; sys.exit(1)" || { true && false; true; }',
            'python -c "import sys; sys.exit(1)" || { false & }',
            'python -c "import sys; sys.exit(1)" || ( false & )',
            'python -c "import sys; sys.exit(1)" & wait',
            'python -c "import sys; sys.exit(1)" &',
            'python -c "import sys; sys.exit(1)" || { true & wait "$!"; }',
            'python -c "import sys; sys.exit(1)" || ! false',
            'python -c "import sys; sys.exit(1)" || { ! false; }',
            'python -c "import sys; sys.exit(1)" || ! ( ! true )',
            'python -c "import sys; sys.exit(1)" || { ! ( ! true ); }',
            ...
            'python -c "import sys; sys.exit(1)" || command -p true',
        ),
    )
