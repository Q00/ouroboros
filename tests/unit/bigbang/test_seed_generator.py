...
class TestSeedGeneratorExtraction:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            "pytest tests/test_app.py -q || $(true)",
            "pytest tests/test_app.py -q || `true`",
            "pytest tests/test_app.py -q || VERIFY_MODE=$(true)",
            "pytest tests/test_app.py -q || VERIFY_MODE=`true`",
            "pytest tests/test_app.py -q || FIRST=$(false) LAST=$(true)",
            "pytest tests/test_app.py -q || FIRST=plain LAST=$(true)",
            "pytest tests/test_app.py -q || VERIFY_MODE=ci >/dev/null",
...
class TestSeedGeneratorRobustParsing:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            "pytest -q || $(true)",
            "pytest -q || `true`",
            "pytest -q || VERIFY_MODE=$(true)",
            "pytest -q || VERIFY_MODE=`true`",
            "pytest -q || FIRST=$(false) LAST=$(true)",
            "pytest -q || FIRST=plain LAST=$(true)",
            "pytest -q || VERIFY_MODE=ci >/dev/null",
            "pytest -q || FOO=${false}",
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            "false || $(false)",
            "false || $(true) false",
            "false || FIRST=$(true) LAST=$(false)",
            "false || FIRST=$(false) LAST=plain",
            'false || "$(true)"',
            "false || ${true}",
        ),
    )
