...
async def test_precreated_retry_replays_pending_pause_before_provider_effect(
    ...
    """Reusing a prepared tracker must persist the retained pause before dispatch."""
    ...
    try:
        ...
        runner._session_repo.mark_paused = original_mark_paused
        retried = await runner.execute_precreated_session(
            seed=_seed(),
            tracker=tracker,
            parallel=False,
        )
